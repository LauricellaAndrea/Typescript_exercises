 ...
 */
 //Un tipo di intersezione combina più tipi in uno solo. 
 //Ciò consente di sommare i tipi esistenti per ottenere un unico tipo con tutte le funzionalità necessarie
